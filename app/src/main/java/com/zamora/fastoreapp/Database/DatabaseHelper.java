...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into detalles_lista (" + DatabaseContract.DataBaseEntry._ID + ",id_lista, id_producto) values('1','2','10')");
        db.execSQL("insert into detalles_lista (" + DatabaseContract.DataBaseEntry._ID + ",id_lista, id_producto) values('2','00100003','11')");
